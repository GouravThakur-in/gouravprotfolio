...
export function Hero() {
  return (
    <section id="hero" className="relative flex min-h-screen items-center overflow-hidden">
      ...
      <div className="section-shell relative pt-32 pb-24">
        <motion.div
        ...
        <motion.p
          ...
          className="mt-8 font-mono text-sm tracking-widest text-muted-foreground uppercase"
        >
          {profile.greeting}
        </motion.p>
        ...
        <motion.h1
          ...
          className="mt-2 text-[clamp(2.8rem,9vw,6.5rem)] leading-[0.95] font-semibold"
        >
        ...
        >
          ...
          <span className="ml-2 h-px w-16 bg-border" />
